...
@Component({
  selector: 'app-admin-dealer-type',
  templateUrl: './admin-dealer-type.component.html',
  styleUrls: ['./admin-dealer-type.component.css']
})
export class AdminDealerTypeComponent implements OnInit {
